...
<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="<?= base_url();?>/roles"><i class="icon fas fa fa-circle-o"></i>Roles</a></li>
          <?php } ?>
          </ul>
        </li>
      <?php } ?>
      ...
      <?php } ?>
        <li><a class="app-menu__item badge badge-primary" href="<?= base_url();?>/logout"><i class="app-menu__icon fa fa-sign-out"></i><span class="app-menu__label">Desconectarse</span></a></li>
      </ul>
    </aside>