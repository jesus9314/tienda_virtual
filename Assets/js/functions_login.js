            ...
            if (document.querySelector('#formLogin')) {
                  ...
                  formLogin.onsubmit = (e) => {
                        ...
                        if (strEmail == "" || strPassword == "") {
                              swal("Por favor", "Escribe usuario y contraseña.", "error"); strPassword;
                              return false;
                        }
                        else {
                              ...
                              request.onreadystatechange = () => {
                                    ...
                                    if (request.status == 200) {
                                          ...
                                          if (objData.status) {
                                                ...
                                                swal("Arención", objData.msg, "error");
                                                document.querySelector('#txtPassword').value = "";
                                          }
                                    }

                                    else {
                                          swal("Arención", "Error en el proceso", "error");
                                    }
                  ...
                  formCambiarPass.onsubmit = (e) => {
                        ...
                        if (strPassword == "" || strPasswordConfirm == "") {
                              ...
                              if (strPassword.length < 5) {
                                    swal("Por favor", "La contraseña debe tener un mínimo de 5 carácteres", "info");
                                    return false;
                              }
                              if (strPassword != strPasswordConfirm) {
