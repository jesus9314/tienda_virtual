...
class Categorias extends Controllers
	{
		...
		{	
			...
			$data['page_tittle']="Categorías <small>Tienda Virtual</small>";
		...
		public function getCategorias()
		{
			if($_SESSION['permisosMod']['r'])
			{
				...
				for ($i=0; $i < count($arrData); $i++) {
					...
					if($_SESSION['permisosMod']['r'])
					{
						$btnView = '<button class="btn btn-info btn-sm btnViewCat" onClick="categorias.ViewInfo('.$arrData[$i]['idcategoria'].')" title="Ver categoria"><i class="far fa-eye"></i></button>';
					}
					if($_SESSION['permisosMod']['u'])
					{
						$btnEdit = '<button class="btn btn-primary  btn-sm btnEditCat" onClick="categorias.EditInfo(this,'.$arrData[$i]['idcategoria'].')" title="Editar categoria"><i class="fas fa-pencil-alt"></i></button>';
					}

					if($_SESSION['permisosMod']['d'])
					{
						$btnDelete = '<button class="btn btn-danger btn-sm btnDeCat" onClick="categorias.DelInfo('.$arrData[$i]['idcategoria'].')" title="Eliminar categoria"><i class="far fa-trash-alt"></i></button>';		
					}
