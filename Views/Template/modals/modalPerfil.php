            ...
            <form id="formPerfil" name="formPerfil" class="form-horizontal">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="txtIdentificacion" value="<?= $_SESSION['userData']['identificacion'] ?>" name="txtIdentificacion" required="">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="email" class="form-control valid validEmail" id="txtEmail" value="<?= $_SESSION['userData']['email_user'] ?>" name="txtEmail" required="" readonly disabled>
                </div>
              </div>
             <div class="form-row">
                <div class="form-group col-md-6">
