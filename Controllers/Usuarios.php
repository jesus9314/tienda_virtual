			...
			if($_SESSION['permisosMod']['r'])
			{
				...
				for ($i=0; $i < count($arrData); $i++) {
					...
					if($_SESSION['permisosMod']['u'])
					{
						...
						{
							$btnEdit = '<button class="btn btn-primary btn-sm btnEditUsuario" disabled title="Editar usuario"><i class="fa fa-pencil"></i></button>';
						}
					}
					...
					if($_SESSION['permisosMod']['d'])
					{
						...
						{
						$btnDelete = '<button class="btn btn-danger btn-sm btnDelCliente" disabled title="Eliminar usuario"><i class="fa fa-trash"></i></button>';
						}
