			...
			<div class="row">
					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table id="tblCarrito" class="table-shopping-cart">
								<tr class="table_head">
									<th class="column-1" colspan="2"><center>Producto</center></th>
									<th class="column-3"><center>Precio</center></th>
							...
							<?php 
							 ...
							 ?>
								<tr class="table_row <?= $idProducto ?>">
									...
									<td class="column-2 name_products"><center><?= $producto['producto'] ?></center></td>
									<td class="column-3"><center><?= SMONEY.formatMoney($producto['precio']) ?></center></td>
									<td class="column-4">
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<button type="submit" href="<?= base_url() ?>/carrito/procesarpago" id="btnComprar" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
							Procesar pago
						</button>
					</div>
				</div>
